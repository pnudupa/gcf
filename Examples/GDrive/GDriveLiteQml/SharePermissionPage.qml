...
Item {
    ...
    signal addSharePermission();
    signal updateSharePermission(string sharedUser);
        ...
        Flickable {
            ...
            Grid {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        currentIndex = index;
                                        sharePermissionPage.updateSharePermission(shareTitle);
                                    }
                                }
                            }
                        }
                        ...
                        Image {
                            ...
                            anchors.leftMargin: 10
                            source: "qrc:///Icons/unshare.png"
                            visible: index > 0 // enableTooltipindex === 0 corresponds to the owner / authenticated user.
                ...
                Rectangle {
                    ...
                    color: shareButtonMouseArea.pressed ? Qt.lighter("gray") : "gray"
                    ...
                    MouseArea {
                        ...
                        hoverEnabled: true
                        anchors.fill: parent
                        onClicked: sharePermissionPage.addSharePermission();
                    }
                }
            }
        }
